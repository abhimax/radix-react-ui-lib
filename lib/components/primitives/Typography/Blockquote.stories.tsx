...
export const Default: Story = {
  args: {
    children:
      "Radix ReactUI Lib combines the power of Radix UI primitives with the flexibility of React components, creating a seamless development experience for modern web applications.",
  },
};
