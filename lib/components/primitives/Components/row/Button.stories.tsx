...
const meta = {
  title: 'Radix React UI/Components/Button',
  component: Button,
  tags: ['autodocs'],
  ...
  argTypes: {
    ...
    variant: {
      ...
      description: 'The visual variant to apply, see theme overview for more details.',
    },
    color: {
      control: 'select',
      ...
      description: 'Overrides the accent color inherited from the Theme. See the color guide for more details.',
    },
    highContrast: {
      control: 'boolean',
    ...
    radius: {
      ...
      description: 'Overrides the radius inherited from the theme. See the radius guide for more details.',
    },
    loading: {
      control: 'boolean',
...
export const IconButton: Story = {
  args: { children: <><Icon name="HomeIcon" size={16} />Home</> },
};
